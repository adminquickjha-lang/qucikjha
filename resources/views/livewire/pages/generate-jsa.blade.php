...
new #[Layout('layouts.safety')] class extends Component {
    ...
    public function getTypeInfoProperty()
    {
        ...
        return $info[strtolower($this->type)] ?? $info['jsa'];
    }
    ...
    public function generate()
    {
        ...
        session()->flash('success', 'JSA document created successfully!');

        return $this->redirectRoute('preview.jsa', ['id' => $doc->id]);
    }
