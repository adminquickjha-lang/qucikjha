...
new #[Layout('layouts.safety', ['seoKey' => 'home'])] class extends Component {
    ...
    public function howItWorks()
    {
        return [
            ...
            ['step' => '04', 'title' => 'Secure Payment', 'desc' => 'Review your document and securely pay via or PayPal.', 'icon' => 'credit-card'],
            ['step' => '05', 'title' => 'Download & Use', 'desc' => 'Download your ready-to-use safety document in PDF or Word format.', 'icon' => 'download'],
        ];
    }
...
<div class="overflow-x-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 py-10">
        ...
        <div class="relative max-w-7xl mx-auto px-4">
            <!-- Connecting Line (Desktop Only) - Starts at step 1 center, ends at step 5 center -->
            <div class="hidden md:block absolute top-[24px] left-[10%] right-[10%] h-0.5 bg-slate-200 z-0"></div>

            <div class="grid md:grid-cols-5 gap-8 lg:gap-12 relative z-10">
                        ...
                        <div class="mb-6 h-20 flex items-end justify-center transition-transform duration-500 group-hover:-translate-y-2">
                            <div class="relative">
                                ...
                                @elseif($item['icon'] === 'credit-card')
                                    <div class="w-16 h-16 bg-indigo-500/10 rounded-2xl flex items-center justify-center text-indigo-600">
