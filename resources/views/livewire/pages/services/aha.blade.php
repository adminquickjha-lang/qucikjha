...
new #[Layout('layouts.safety', ['seoKey' => 'aha'])] class extends Component {
    ...
    {
        return [
            ['step' => '01', 'title' => 'Fill Project Details', 'desc' => 'Enter your project name, location, company info, and activity details for the AHA.', 'icon' => 'file-check'],
            ['step' => '02', 'title' => 'Select Regulations', 'desc' => 'Choose applicable EM 385-1-1, OSHA, and project-specific standards.', 'icon' => 'shield-check'],
            ['step' => '03', 'title' => 'Document Creation', 'desc' => 'Our engine identifies activity hazards, control measures, and RAC updates instantly.', 'icon' => 'zap'],
            ['step' => '04', 'title' => 'Download & Use', 'desc' => 'Preview, pay, and download your AHA in PDF or Word.', 'icon' => 'download'],
        ];
    }
    ...
    public function faqs()
    {
        return [
            [
                'question' => 'What is an Activity Hazard Analysis (AHA)?',
                'answer' => 'An Activity Hazard Analysis (AHA) is a planning document used to identify hazards for a specific activity before work begins. It breaks the activity into steps, highlights the hazards in each phase, and assigns controls to reduce risk before crews start work.',
            ],
            [
                'question' => 'Are your AHAs suitable for EM 385 and USACE-style projects?',
                'answer' => 'Yes, our AHA flow is designed for detailed activity planning and supports the type of hazard review, control planning, and risk tracking commonly expected on EM 385-1-1 and USACE-driven projects.',
            ],
            [
                'question' => 'Can I edit the created AHA?',
                'answer' => 'Absolutely. After download, you get a PDF plus a fully editable Word version so your team can adjust controls, personnel details, and activity notes for the site.',
            ],
        ];
    }

    public function getAhaPriceProperty()
    {
        return Setting::where('key', 'aha_price')->value('value') ?? '19.90';
    }
}; ?>
...
<div class="overflow-x-hidden">
            ...
            <div class="flex flex-col items-center justify-center text-center max-w-6xl mx-auto">
                <div class="space-y-6 max-w-3xl mx-auto mt-4">
                    <span class="bg-primary/10 text-primary border border-primary/20 rounded-full px-5 py-1.5 text-xs font-black tracking-widest uppercase shadow-sm">
                        Activity Hazard Analysis Detail
                    </span>
                    <h1 class="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-4 leading-[1.2] text-brand-dark max-w-5xl mx-auto text-center">
                        ...
                        <span class="text-primary block">Safety AHAs</span>
                    </h1>
                    
                    <p class="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed font-medium opacity-90 mb-8">
                        Instantly create detailed Activity Hazard Analysis documents tailored to each activity. Professional formatting, zero effort, and built for rigorous safety environments.
                    </p>

                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="{{ route('generate.aha') }}" wire:navigate class="group relative inline-flex items-center justify-center px-10 py-5 font-black text-sm uppercase tracking-widest text-white bg-primary rounded-2xl shadow-xl shadow-primary/20 transition-all overflow-hidden w-full sm:w-auto border-0">
                        ...
                        <a href="/examples/aha.pdf" download class="group relative inline-flex items-center justify-center gap-3 bg-white border border-slate-200 text-brand-dark font-black px-8 py-5 rounded-2xl text-sm uppercase tracking-widest hover:bg-slate-50 transition-all w-full sm:w-auto shadow-sm">
    ...
    <!-- 2. What is AHA Section -->
    <section id="what-is-aha" class="py-20 bg-slate-50 border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="space-y-6">
                    <span class="bg-primary/10 text-primary border border-primary/20 rounded-full px-4 py-1 text-xs font-semibold inline-block">The Foundation of Planning</span>
                    <h2 class="text-4xl md:text-5xl font-black tracking-tight text-slate-900">What is an Activity Hazard Analysis?</h2>
                    <p class="text-lg text-slate-600 leading-relaxed font-medium">
                        An Activity Hazard Analysis (AHA) is a structured planning tool used to identify and control hazards tied to a specific activity before work begins. It focuses on the activity sequence, associated hazards, and the measures needed to reduce risk.
                    </p>
                    <p class="text-lg text-slate-600 leading-relaxed font-medium">
                        By breaking work into activity-based steps, an AHA helps teams document hazards, assign controls, and track risk reduction in a way that supports higher-accountability project environments.
                    </p>
                    ...
                    <div class="pt-4 flex items-center gap-4">
                        ...
                        <span class="text-slate-900 font-bold">Recommended for EM 385 and detailed project safety planning</span>
                    </div>
                </div>
                <div class="relative">
                    <div class="bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
                        <h3 class="text-xl font-bold mb-6 border-b pb-4">Key Components of our AHA</h3>
                        <ul class="space-y-4">
                            <li class="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-bold text-slate-800">Activity Breakdown</h4>
                                    <p class="text-sm text-slate-500">Divide the activity into clear, logical work phases.</p>
                                </div>
                            </li>
                            <li class="flex items-start gap-4">
                                <div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold shrink-0 mt-1">2</div>
                                <div>
                                    <h4 class="font-bold text-slate-800">Hazard and RAC Review</h4>
                                    <p class="text-sm text-slate-500">Identify hazards and document initial and residual risk clearly.</p>
                                </div>
                            </li>
                            <li class="flex items-start gap-4">
                                <div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold shrink-0 mt-1">3</div>
                                <div>
                                    <h4 class="font-bold text-slate-800">Control Measures</h4>
                                    <p class="text-sm text-slate-500">Assign controls, PPE, and planning measures before work starts.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-16">
                <span class="bg-primary/10 text-primary border border-primary/20 rounded-full px-4 py-1 text-xs font-semibold mb-4 inline-block">AHA Features</span>
                <h2 class="text-4xl md:text-5xl font-black tracking-tight mb-4">Precision Engineered for Safety</h2>
                <p class="text-muted-foreground max-w-xl mx-auto font-medium">Our platform creates AHAs equipped with robust features designed perfectly for rigorous safety environments.</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8">
                @foreach([
                    ['title' => 'Activity-Based Steps', 'desc' => 'Clear work sequencing that aligns hazards with the actual activity flow.', 'icon' => 'list'],
                    ['title' => 'Initial & Residual RAC', 'desc' => 'Track risk levels before and after controls are applied.', 'icon' => 'bar-chart'],
                    ['title' => 'Targeted Control Measures', 'desc' => 'Document practical controls for each hazard and activity phase.', 'icon' => 'shield'],
                    ['title' => 'Competent Person Context', 'desc' => 'Support activity planning with supervisory and role-based detail.', 'icon' => 'book'],
                    ['title' => 'PPE Recommendations', 'desc' => 'Map protective equipment needs to the specific work being performed.', 'icon' => 'hard-hat'],
                    ['title' => 'Signature Ready', 'desc' => 'Built-in formatting ready for field review, approvals, and toolbox use.', 'icon' => 'pen']
                ] as $feature)
    ...
    <section class="py-20 bg-slate-900 border-y border-slate-800 text-white relative overflow-hidden text-center">
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10">
            ...
            <p class="text-slate-400 text-lg mb-10 font-medium">
                Our engine does the heavy lifting, identifying activity hazards and proposing controls so you can focus on field safety. Detailed planning is just a few clicks away.
            </p>
    ...
    <section class="py-20 bg-slate-900 text-white">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <p class="text-slate-400 max-w-2xl mx-auto mb-16 font-medium text-lg">From federal projects to private-sector operations, our AHAs support the level of planning expected in controlled and high-risk work environments.</p>
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-12">
                ...
                <span class="bg-white/10 px-6 py-3 rounded-full text-sm font-bold border border-white/10">Mechanical</span>
                <span class="bg-white/10 px-6 py-3 rounded-full text-sm font-bold border border-white/10">Civil Works</span>
            ...
            <div class="flex items-center justify-center gap-8 border-t border-white/10 pt-10">
                <div class="text-center">
                    ...
                    <span class="font-black text-xl">EM 385-1-1</span>
                    <p class="text-xs text-white/50 uppercase tracking-widest mt-1">USACE Planning</p>
                </div>
                <div class="text-center">
                    ...
                    <span class="font-black text-xl">OSHA</span>
                    <p class="text-xs text-white/50 uppercase tracking-widest mt-1">Activity Safety</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-left">
                    ...
                    <p class="text-slate-600 font-semibold mb-6">"The AHA creation saved us hours. We got a structured activity plan with hazards, controls, and risk flow ready for review almost instantly."</p>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-left">
                    ...
                    <p class="text-slate-600 font-semibold mb-6">"Our team uses the editable Word file to fine-tune site-specific controls, and the layout is clean enough to share directly in planning meetings."</p>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-left">
                    ...
                    <p class="text-slate-600 font-semibold mb-6">"For high-risk activities, having a fast way to produce professional AHAs makes approvals, coordination, and daily planning much easier."</p>
                    <div class="font-black text-slate-900 text-sm">Dave C.</div>
                    <div class="text-xs text-slate-500 uppercase tracking-wider">Project Coordinator</div>
                </div>
            </div>
        </div>
    </section> -->
    ...
    <section class="py-20 bg-white">
        <div class="max-w-3xl mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <h2 class="text-4xl font-black mb-4 tracking-tight">AHA FAQ</h2>
            </div>
