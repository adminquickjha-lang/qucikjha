...
new #[Layout('layouts.safety', ['seoKey' => 'jha'])] class extends Component {
    ...
    public function howItWorks()
    {
        return [
            ...
            ['step' => '02', 'title' => 'Select Regulations', 'desc' => 'Choose applicable OSHA regulations for the JHA.', 'icon' => 'shield-check'],
            ['step' => '03', 'title' => 'Document Creation', 'desc' => 'Our engine identifies hazards and creates control measures instantly.', 'icon' => 'zap'],
            ['step' => '04', 'title' => 'Download & Use', 'desc' => 'Preview, pay, and download your JHA in PDF or Word.', 'icon' => 'download'],
        ];
    }
    ...
    public function faqs()
    {
        return [
            [
                ...
                'answer' => "A Job Hazard Analysis (JHA) is a safety management tool used to identify and control hazards related to specific job tasks. It breaks down the job into steps, identifies potential hazards for each step, and recommends safe work procedures to eliminate or reduce those hazards."
            ],
            [
                'question' => "Are your JHAs OSHA compliant?",
                'answer' => "Yes, our JHAs are fully formatted and created following standard industry guidelines ensuring compliance with OSHA General Industry (29 CFR 1910) and Construction (29 CFR 1926)."
            ],
            [
                'question' => "Can I edit the created JHA?",
                'answer' => "Absolutely! When you download the document, you receive both a PDF and a fully editable Word format, so you can tailor specific controls to your unique job site conditions."
            ]
        ];
    }
    
    public function getJhaPriceProperty()
    {
        return Setting::where('key', 'jha_price')->value('value') ?? '19.90';
    }
}; ?>

<div class="overflow-x-hidden">
    <!-- 1. Hero Section -->
    <section class="relative min-h-[500px] flex items-center py-10 bg-slate-50 text-brand-dark">
            ...
            <div class="flex flex-col items-center justify-center text-center max-w-6xl mx-auto">
                <div class="space-y-6 max-w-3xl mx-auto mt-4">
                    ...
                    <h1 class="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-4 leading-[1.2] text-brand-dark max-w-5xl mx-auto text-center">
                        ...
                        <span class="text-primary block">Safety JHAs</span>
                    </h1>
                    
                    <p class="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed font-medium opacity-90 mb-8">
                        Instantly create OSHA-compliant documents tailored to your job steps. Professional formatting, zero effort, and built for rigorous safety environments.
                    </p>

                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="{{ route('generate.jha', ['type' => 'jha']) }}" wire:navigate class="group relative inline-flex items-center justify-center px-10 py-5 font-black text-sm uppercase tracking-widest text-white bg-primary rounded-2xl shadow-xl shadow-primary/20 transition-all overflow-hidden w-full sm:w-auto border-0">
                        ...
                        <a href="/examples/jha.pdf" download class="group relative inline-flex items-center justify-center gap-3 bg-white border border-slate-200 text-brand-dark font-black px-8 py-5 rounded-2xl text-sm uppercase tracking-widest hover:bg-slate-50 transition-all w-full sm:w-auto shadow-sm">
    ...
    <!-- 2. What is JHA Section -->
    <section id="what-is-jha" class="py-10 bg-slate-50 border-b border-slate-100">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="space-y-6">
                    <span class="bg-primary/10 text-primary border border-primary/20 rounded-full px-4 py-1 text-xs font-semibold inline-block">The Foundation of Safety</span>
                    <h2 class="text-4xl md:text-5xl font-black tracking-tight text-slate-900">What is a Job Hazard Analysis?</h2>
                    <p class="text-lg text-slate-600 leading-relaxed font-medium">
                        A Job Hazard Analysis (JHA) is a specialized technique that focuses on job tasks as a way to identify hazards before they occur. It focuses on the relationship between the worker, the task, the tools, and the work environment.
                    </p>
                    <p class="text-lg text-slate-600 leading-relaxed font-medium">
                        By meticulously breaking down a job into simple steps, a JHA facilitates the discovery of uncontrolled hazards and outlines the necessary preventive measures to establish safer working conditions.
                    </p>
                    ...
                    <div class="pt-4 flex items-center gap-4">
                        ...
                        <span class="text-slate-900 font-bold">Recommended for OSHA Compliance</span>
                    </div>
                </div>
                <div class="relative">
                    <div class="bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
                        <!-- Abstract Visual or List representing Breaking Down Tasks -->
                        <h3 class="text-xl font-bold mb-6 border-b pb-4">Key Components of our JHA</h3>
                        <ul class="space-y-4">
                            <li class="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 class="font-bold text-slate-800">Job Task Breakdown</h4>
                                    <p class="text-sm text-slate-500">Divide the job into distinct, logical steps.</p>
                                </div>
                            </li>
                            <li class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500">Spot potential risks in each specific step.</p>
                                </div>
                            </li>
                            <li class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-slate-500">Assign protective actions and PPE requirements.</p>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <section class="py-10 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-16">
                <span class="bg-primary/10 text-primary border border-primary/20 rounded-full px-4 py-1 text-xs font-semibold mb-4 inline-block">JHA Features</span>
                <h2 class="text-4xl md:text-5xl font-black tracking-tight mb-4">Precision Engineered for Safety</h2>
                <p class="text-muted-foreground max-w-xl mx-auto font-medium">Our platform creates JHAs equipped with robust features designed perfectly for rigorous safety environments.</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8">
                @foreach([
                    ['title' => '5+ Job Steps Identified', 'desc' => 'Comprehensive breakdowns ensuring no minor action is overlooked.', 'icon' => 'list'],
                    ['title' => 'Risk Assessment Codes', 'desc' => 'Categorical identification measuring severity and probability.', 'icon' => 'bar-chart'],
                    ['title' => 'Targeted Control Measures', 'desc' => 'Exact remedies preventing predictable hazardous outcomes.', 'icon' => 'shield'],
                    ['title' => 'Required Training List', 'desc' => 'Identification of skills needed before touching the tools.', 'icon' => 'book'],
                    ['title' => 'PPE Recommendations', 'desc' => 'Detailed matrix mapping the protective gear to job requirements.', 'icon' => 'hard-hat'],
                    ['title' => 'Signature Ready', 'desc' => 'Built-in attendance and sign-off formats for toolbox talks.', 'icon' => 'pen']
                ] as $feature)
    ...
    <!-- 4. Content Section -->
    <section class="py-10 bg-slate-900 border-y border-slate-800 text-white relative overflow-hidden text-center">
        <div class="absolute bottom-0 left-0 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[150px]"></div>
        <div class="max-w-4xl mx-auto px-4 relative z-10">
            ...
            <p class="text-slate-400 text-lg mb-10 font-medium">
                Our engine does the heavy lifting, identifying hazards and proposing controls so you can focus on field safety. OSHA compliance is just a few clicks away.
            </p>
    ...
    <section class="py-20 bg-slate-900 text-white">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <p class="text-slate-400 max-w-2xl mx-auto mb-16 font-medium text-lg">From massive construction sites to local service providers, our JHAs carry the credibility of standard OSHA frameworks.</p>
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-12">
                ...
                <span class="bg-white/10 px-6 py-3 rounded-full text-sm font-bold border border-white/10">Oil & Gas</span>
        ...
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-left">
                    ...
                    <p class="text-slate-600 font-semibold mb-6">"The JHA creation blew me away. What usually took me two hours to write up, format, and align was done beautifully in 30 seconds."</p>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-left">
                    ...
                    <p class="text-slate-600 font-semibold mb-6">"Our teams use the downloaded word doc, tweak a couple of controls for site-specific nuances, and present them at toolbox talks constantly. Brilliant tool."</p>
                ...
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 text-left">
                    ...
                    <p class="text-slate-600 font-semibold mb-6">"I'm an independent contractor. Having a tool that allows me to spit out reliable OSHA compliant JHAs to submit with my bids is a game changer."</p>
                    <div class="font-black text-slate-900 text-sm">Dave C.</div>
                    <div class="text-xs text-slate-500 uppercase tracking-wider">Independent Contractor</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-3xl mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <h2 class="text-4xl font-black mb-4 tracking-tight">JHA FAQ</h2>
            </div>
