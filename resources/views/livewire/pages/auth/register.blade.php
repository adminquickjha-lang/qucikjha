...
new #[Layout('layouts.safety')] class extends Component {
    ...
    public function register(): void
    {
        ...
        Session::flash('success', "Account created! Welcome aboard, {$user->name}.");
            ...
            <form wire:submit="register" class="space-y-4">
                ...
                <div class="pt-2">
                    <button type="submit"
                        ...
                        <span wire:loading.remove wire:target="register" class="relative z-10">
                            Sign Up
                        </span>
                        <span wire:loading wire:target="register" style="display:none;" class="relative z-10">
                            Creating account...
                        </span>
                    </button>
